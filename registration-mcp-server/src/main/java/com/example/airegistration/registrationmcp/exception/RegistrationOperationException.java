package com.example.airegistration.registrationmcp.exception;
...
public class RegistrationOperationException extends RuntimeException {
    ...
    public RegistrationOperationException(ApiErrorCode errorCode, String message, Map<String, Object> details) {
